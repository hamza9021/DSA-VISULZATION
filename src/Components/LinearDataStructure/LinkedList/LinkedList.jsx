...
const LinkedList = () => {
  ...
  <div className="flex flex-wrap justify-center gap-8 p-6 md:gap-10">
    <div className="flex flex-col items-center w-full sm:w-40">
      <label htmlFor="insertFirst" className="font-semibold text-gray-700 mb-1">
        Insert First:
      </label>
      <input
        type="number"
    ...
    <div className="flex flex-col items-center w-full sm:w-40">
      <label htmlFor="insertLast" className="font-semibold text-gray-700 mb-1">
        Insert Last:
      </label>
      <input
        type="number"
    ...
    <div className="flex flex-col items-center w-full sm:w-40">
      <label htmlFor="deleteFirst" className="font-semibold text-gray-700 mb-1">
        Delete First:
      </label>
      <button
    ...
    <div className="flex flex-col items-center w-full sm:w-40">
      <label htmlFor="deleteLast" className="font-semibold text-gray-700 mb-1">
        Delete Last:
      </label>
      <button
    ...
    <div className="flex flex-col items-center w-full sm:w-40">
      <label htmlFor="insertAtSpecificValue" className="font-semibold text-gray-700 mb-1">
    ...
    <div className="flex flex-col items-center w-full sm:w-40">
      <label htmlFor="deleteAtSpecificValue" className="font-semibold text-gray-700 mb-1">
